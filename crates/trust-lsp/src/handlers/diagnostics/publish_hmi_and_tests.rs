...
mod tests {
    use super::{
        collect_hmi_toml_diagnostics_for_root, top_ranked_suggestions, LearnerContext,
    };
...
"#;
        ...
        // Semantic HMI diagnostics are deprecated in trust-lsp; only parse diagnostics remain.
        assert!(
            diagnostics.is_empty(),
            "expected no diagnostics after HMI semantic deprecation, got: {diagnostics:#?}"
        );
