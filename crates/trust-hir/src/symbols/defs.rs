...
use crate::db::FileId;
use crate::types::{InitializerId, TypeId};
...
pub struct Symbol {
    ...
    /// Persistence qualifier (RETAIN, PERSISTENT, NON_RETAIN).
    pub persistence: Option<SmolStr>,
    /// Edge qualifier (R_EDGE, F_EDGE).
    pub edge: Option<SmolStr>,
    /// Initializer reference (optional).
